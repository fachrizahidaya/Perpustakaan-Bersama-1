...
export default function CartDetail() {
  const { NIM, email, isVerified, cart } = useSelector(
              ...
              <>
                ...
                >
                  ...
                  <Box display="flex" mt="10px" justifyContent="center">
                    <Image
                      src={`https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${i.no_invoice}`}
                    />
                  </Box>
                  <Box display="flex" mt="10px" justifyContent="space-between">
                    <Text fontWeight="semibold">No Invoice :</Text>
                    <Text fontWeight="semibold">{i.no_invoice}</Text>
                  </Box>
                  <Box display="flex" mt="10px" justifyContent="space-between">
                    <Text fontWeight="semibold">NIM :</Text>
                    <Text fontWeight="semibold">{i.UserNIM}</Text>
                  </Box>
                  <Box display="flex" mt="10px" justifyContent="space-between">
                    ...
                    >
                      <Text fontWeight="semibold">{i.transaction_status}</Text>
                    </Badge>
                  </Box>
                  ...
                  <Box display="flex" mt="30px" justifyContent="space-between">
                    <Text fontWeight="bold">Jumlah Buku :</Text>
                    <Text fontWeight="bold">{i.Loan_Details.length}</Text>
                  </Box>
                </Box>
